...
It seems as though it is only possible to take one or the other.
For example, suppose you take the infinite volume limit first, holding physical $a$, $\beta$, $\mu$, and $\vec{h}$ fixed.
...
\end{align}
If we start with $\mu=0$ and $\vec{h}=0$, the result is universal, indepdendent of $a$!
