...
When we construct fermion matrices we \incode{tdg/action.py\#L76}{construct the auxiliary field action} we incorporate this shift in $\tilde{\mu}$ and henceforth use
\begin{align}
	\BB &= B \otimes \one
	&
