...
\begin{align}
	...
	\\
	&= \int d^2x\; \frac{\grad \psi\adjoint \cdot \grad \psi}{M} - g \left[\psi\adjoint_1(x) \psi_1(x)\right] \left[\psi\adjoint_2(y) \psi_2(y)\right]
\end{align}
...
\begin{align}
	HM
	&= \int d^2x\; \grad \psi\adjoint \cdot \grad \psi - gM \left[\psi\adjoint_1(x) \psi_1(x)\right] \left[\psi\adjoint_2(y) \psi_2(y)\right]
\end{align}
