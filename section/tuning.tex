...
\begin{figure}
	...
	\caption{
		...
		Right:
			With the tunings shown at left, the finite-volume energies processsed through the quantization condtion \eqref{quantization condition dimensionless}; red circles correspond to $N_x=5$, orange triangles to $N_x=7$, and so on until $N_x=45$.
	}
...
By eye it's not clear there's actually an improvement.
