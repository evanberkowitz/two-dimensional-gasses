...
\begin{figure}
	\includegraphics[width=0.3\textwidth]{mathematica/figure/convergence-coupling}
	\includegraphics[width=0.55\textwidth]{mathematica/figure/convergence-amplitude}
	\caption{
		Left:
