...
We give an example calculation of \incode{docs/sanity-checks/free-theory-continuum-limit.ipynb}{the free-theory continuum extrapolation}, which shows a staggered behavior based on $N_x\mod{4}$.
