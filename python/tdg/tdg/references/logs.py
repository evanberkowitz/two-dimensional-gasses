################################################################################
#
# The below is a way to add levels to the built-in logger.
# It originates from a stackoverflow answer
#
#     https://stackoverflow.com/questions/2183233/how-to-add-a-custom-loglevel-to-pythons-logging-facility/35804945#35804945
#
# which was made robust as part of haggis, an Affero GPL-licensed package.
#
#    https://haggis.readthedocs.io/en/stable/index.html
#
# It consists of an extraction of the Sentinel class from the __init__.py of the module,
#
#    https://gitlab.com/madphysicist/haggis/-/blob/master/src/haggis/__init__.py#L43
#    https://github.com/madphysicist/haggis/blob/992fd229799f90fef44d00cbb62820fc8a84bcf4/src/haggis/__init__.py#L43
#
# added to a verbatim copy of the logs.py
#
#    https://gitlab.com/madphysicist/haggis/-/blob/master/src/haggis/logs.py
#    https://github.com/madphysicist/haggis/blob/master/src/haggis/logs.py
#
# from commit 362f1b4.
#
# Since the AGPL allows extraction and combination with GPL-licensed works,
# we include it here.  The AGPL is provided in LICENSES/AGPL.
#
################################################################################
